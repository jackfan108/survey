...
export const WeightedScoresPlot: React.FC<WeightedScoresPlotProps> = ({ scores }) => {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/20 p-6 sm:p-8 mb-16">
      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 p-6">
        ...
        <div className="relative">
          {/* Scale background */}
          <div className="relative h-24 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-red-500/20 rounded-lg border border-white/20 mb-4">
            {/* Scale markers */}
            ...
            <div className="absolute inset-0">
              {validScores.map((score) => {
                ...
                return (
                  ...
                  >
                    {/* Data point */}
                    <div className="w-4 h-4 bg-gradient-to-br from-white to-blue-100 rounded-full border-2 border-blue-500 shadow-xl hover:scale-125 hover:shadow-2xl transition-all duration-200 cursor-pointer ring-2 ring-blue-400/50">
                    </div>
          ...
          <div className="flex justify-between px-2">
            <span className="text-sm text-blue-300 font-medium">More Liberal</span>
            <span className="text-sm text-red-300 font-medium">More Conservative</span>
          </div>
        </div>

        {/* Score list for reference */}
        <div className="mt-6">
          <h4 className="text-white font-medium mb-3 text-center">Individual Survey Scores</h4>
          <div className="max-h-32 overflow-y-auto bg-white/5 rounded-lg p-3">
